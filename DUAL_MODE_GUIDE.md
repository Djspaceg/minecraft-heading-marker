...
- **Main entrypoint**: Runs on the logical server (dedicated server OR integrated server in
  singleplayer)
...
A: Custom packets would require clients to have the mod. Using server-side waypoint entities works
for all clients.
