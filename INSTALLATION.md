...
This guide will walk you through installing the Heading Marker data pack and resource pack for
...
1. **Locate your Minecraft saves folder:**
    ...
    - **macOS:** Press `Cmd + Shift + G` in Finder, type
      `~/Library/Application Support/minecraft/saves` and press Enter
...
1. **Locate your Minecraft resource packs folder:**
    ...
    - **macOS:** Press `Cmd + Shift + G` in Finder, type
      `~/Library/Application Support/minecraft/resourcepacks` and press Enter
