...
tellraw @s ["",{"text":"/function heading_marker:set {x:-250, y:64, z:450, color:2}","color":"aqua","clickEvent":{"action":"suggest_command","value":"/function heading_marker:set {x:-250, y:64, z:450, color:2}"},"hoverEvent":{"action":"show_text","contents":"Click to edit and run"}}]
