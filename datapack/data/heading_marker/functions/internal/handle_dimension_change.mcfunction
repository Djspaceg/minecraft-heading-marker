...
execute if score @s hm.prev_dim matches -2147483648..2147483647 run function heading_marker:internal/save_dimension_uuid

# Update previous dimension tracker
scoreboard players operation @s hm.prev_dim = @s hm.dimension

# Load markers for new dimension
function heading_marker:internal/load_dimension_uuid
