...
execute unless score @s hm.input.color matches 0..4 run function heading_marker:internal/auto_select_color
...
execute if score @s hm.input.color matches 0 run function heading_marker:internal/set_red
execute if score @s hm.input.color matches 1 run function heading_marker:internal/set_blue
execute if score @s hm.input.color matches 2 run function heading_marker:internal/set_green
execute if score @s hm.input.color matches 3 run function heading_marker:internal/set_yellow
execute if score @s hm.input.color matches 4 run function heading_marker:internal/set_purple
