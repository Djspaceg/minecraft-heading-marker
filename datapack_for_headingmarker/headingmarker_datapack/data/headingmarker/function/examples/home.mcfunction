...
tellraw @s ["",{"text":"/function headingmarker:set {x:0, y:64, z:0, color:0}","color":"aqua","clickEvent":{"action":"suggest_command","value":"/function headingmarker:set {x:0, y:64, z:0, color:0}"},"hoverEvent":{"action":"show_text","contents":"Click to edit and run"}}]
