...
tellraw @s ["",{"text":"/function headingmarker:set {x:100, y:12, z:-200, color:1}","color":"aqua","clickEvent":{"action":"suggest_command","value":"/function headingmarker:set {x:100, y:12, z:-200, color:1}"},"hoverEvent":{"action":"show_text","contents":"Click to edit and run"}}]
