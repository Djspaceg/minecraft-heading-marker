...
tellraw @s {"text":""}
tellraw @s [{"text":"Set Waypoint (3D): ","color":"yellow"},{"text":"[Click]","color":"green","clickEvent":{"action":"suggest_command","value":"/function headingmarker:set {x:1000,y:64,z:-500}"},"hoverEvent":{"action":"show_text","value":"Click to copy command"}}]
