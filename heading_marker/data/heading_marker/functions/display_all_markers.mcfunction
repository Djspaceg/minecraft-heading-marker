...
execute if score @s hm.red.active matches 1 run function heading_marker:internal/calc_red
execute if score @s hm.blue.active matches 1 run function heading_marker:internal/calc_blue
execute if score @s hm.green.active matches 1 run function heading_marker:internal/calc_green
execute if score @s hm.yellow.active matches 1 run function heading_marker:internal/calc_yellow
execute if score @s hm.purple.active matches 1 run function heading_marker:internal/calc_purple

# Display combined actionbar - show markers with icons and distances
function heading_marker:internal/show_actionbar
