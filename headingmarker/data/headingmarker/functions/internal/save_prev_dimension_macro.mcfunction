...
execute if score @s hm.prev_dim matches 0 run data modify storage headingmarker:temp dim set value "overworld"
execute if score @s hm.prev_dim matches -1 run data modify storage headingmarker:temp dim set value "nether"
execute if score @s hm.prev_dim matches 1 run data modify storage headingmarker:temp dim set value "end"
