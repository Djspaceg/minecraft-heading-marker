...
tellraw @a ["",{"text":"Type ","color":"gray"},{"text":"/function headingmarker:help","color":"aqua","clickEvent":{"action":"suggest_command","value":"/function headingmarker:help"},"hoverEvent":{"action":"show_text","contents":"Click to run help command"}},{"text":" for commands and examples","color":"gray"}]
