...
tellraw @s ["",{"text":"/function headingmarker:set {x:800, y:72, z:-600, color:3}","color":"aqua","clickEvent":{"action":"suggest_command","value":"/function headingmarker:set {x:800, y:72, z:-600, color:3}"},"hoverEvent":{"action":"show_text","contents":"Click to edit and run"}}]
