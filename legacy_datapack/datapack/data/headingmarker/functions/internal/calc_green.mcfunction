# Internal: Calculate Green Marker Distance
...
scoreboard players operation @s hm.dx -= @s hm.green.x
scoreboard players operation @s hm.dz = @s hm.temp
scoreboard players operation @s hm.dz -= @s hm.green.z
...
execute store result score @s hm.green.dist run scoreboard players get @s hm.dist
